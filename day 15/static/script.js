document.addEventListener("DOMContentLoaded", () => {
    ...
    // Unified logic for what happens after audio finishes playing
    const onAudioEnded = () => {
        statusDisplay.textContent = "Click the microphone to record again.";
        recordBtn.disabled = false;
    };

    // Event listener for the AI's response audio
    ...
    const handleStopRecording = async () => {
        ...
        try {
            ...
            // The audio player's 'ended' event will now handle the next step for both success and error paths
        }
    };
